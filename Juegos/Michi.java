...
public class Michi {
    ...
    */
    ...
    static void iniciarJuego(int modo) {
        if (modo != JUGADOR_JUGADOR && modo != JUGADOR_CPU) {
            System.out.print("Modo de Juego Invalido");
            return;
        }
            ...
            if (modo == JUGADOR_JUGADOR || (modo == JUGADOR_CPU && jugadorActual == JUGADOR_X)) {
                ...
                do {
                    ...
                    if (!coordenadasVacias(y - 1, x - 1, tablero)) {
                        System.out.println("Ya Esta Ocupado. Intenta De Nuevo");
                    }
                ...
                // Si es el turno del CPU, dejamos que las coordenadas las elija
                // el programa
        ...
        while (true) {
            ...
            if (sc.hasNextInt()) {
                ...
                if (numero >= minimo && numero <= maximo) {
                    ...
                    System.out.println("No Huyas Cobarde, Elige tu Destino");
                }
            } else {
                sc.next();
            }
    ...
    public static void main(String[] args) {
        int modo;
        String menu = "1. 1 VS 2\n2. 1 VS CPU (" + JUGADOR_CPU_O + ")\nElige: ";
        modo = solicitarNumeroValido(menu, 1, 2);
        iniciarJuego(modo);
        sc.close();
    }
}
