...
public class AccionesPersona {
    ...
    /*
     * voy a necesitar hacer una instancia de persona para poder manipular los datos
     * y guardarlos dentro de un objeto que pueda soportar diferentes tipos de dato,
     * para ello ocupo ArrayList
     */
    ...
    public Persona buscarPersona(int id) {
        ...
        // necesito recorrer todo el arreglo de personas hasta encontrar el id que
        // quiero
        // id = parametro
    ...
    public void actualizarPersona(Persona actualizada) { // este es el boton
        // primero debo de buscar a una persona, obtener sus datos y elegir cual voy a
        // cambiar
