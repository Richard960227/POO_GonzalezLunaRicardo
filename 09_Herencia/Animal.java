...
public class Animal {
     ...
     * constructores
     * 
     * El constructor nos sirve para poder declarar la existencia de una clase para
     * poder inicializar las variables de la clase para poder hacer las instancias
     * de la clase
     * 
     */
    ...
    public Animal() {
        ...
        /**
         * Podemos inicializar las variables Podemos aplicar la sobrecarga
         */
    }

    public Animal(String nombre, String raza, String tipo_alimento, int edad, char sexo) {
        // podemos realizar operaciones con cada uno de los parametros
        /*
         * Se estan obteniendo el paso de parametros de cada una de las variables para
         * conocer su valor
         */
        this.nombre = nombre;
        this.raza = raza;
