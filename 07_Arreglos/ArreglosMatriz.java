...
public class ArreglosMatriz {
    ...
    public static void main(String[] args) {
        /*
         * Vamos a realizar un arreglo unidimensional y recorreclo para ver que hay
        ...
        for (int i = 0; i < matriz.length; i++) {
            ...
            for (int j = 0; j < matriz.length; j++) {
                ...
                System.out
                        .println("Ingresa el valor de la fila: " + i + " Ingresa el valor de la columna : " + j + " ");
        ...
        for (int i = 0; i < matriz.length; i++) {
            ...
            System.out.println(String.format("\n Suma de las filas %f, Promedio de la fila %.2f", sumarFilas,
                    sumarFilas / matriz.length));
        }
    }

    /*
     * Para el primero solo es un if(num > 0){ positivo y lo guardo en un arreglo
     * }else{ negativo y lo guardo en otro arreglo }
     */
}