...
//metodo para encontrar raiz del vertice
...
//metodo que determine si 2 vertices estan o no en el mismo componente
...
struct Arista{
	...
	//necesito un arreglo de aristar para el uso del
}arista[MAX];
...
void Kruskal(){
	...
	/*
	si el MST no posee todos los vertices, entonces mostramos un mensaje de error
	porque debemos saber si contiene o no todos los verticescon el numero de 
	aristas que sea igual al numero de vertices -1*/
}
