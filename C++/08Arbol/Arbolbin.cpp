...
//vamos a crear una definicion de la operacion de las ramas izq y der

_nodo *crear(char dato){
	_nodo *nuevo;
	//necesitamos solicitar el tamaño de la estructura
	//cuanto se reserva de memoria <<sizeof>>
	nuevo = (_nodo *)malloc(sizeof(_nodo));//malloc reserva de memoria
	nuevo -> dato = dato;
	nuevo -> der = NULL;
	nuevo -> izq = NULL;
