...
class sumadedosnumeros {
    ...
    public static void main(String[] args) {
        ...
        /*
         * Para realizar una instancia del objeto se debe de colocar: Nombreclase
         * nombreobjeto = new Nombreclase(); System.in Es una clase superior donde
         * nosotros podemos obtener los datos que vienen por parte de la entrada
         * estandar de la computadora (por parte de la consola)
         */
